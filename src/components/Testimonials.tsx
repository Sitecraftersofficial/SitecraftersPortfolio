...
const testimonials: Testimonial[] = [
  {
    ...
    content: "SiteCrafters transformed our gym's online presence completely. The new website with class scheduling and membership management has streamlined our operations and increased member engagement by 150%.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Working with SiteCrafters was a game-changer for our agency. Their modern web design and SEO optimization helped us attract 300% more qualified leads and establish ourselves as industry leaders.",
    rating: 5,
  ...
  },
  {
    ...
    company: "Luxe Drive",
    content: "The conversion-focused landing page SiteCrafters built for our car rental service exceeded all expectations. Online bookings increased by 250% within the first month of launch.",
    rating: 5,
  ...
  },
  {
    ...
    content: "SiteCrafters rebuilt our e-commerce platform from the ground up. The new design and functionality increased our conversion rate by 180% and cut our bounce rate in half.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The restaurant website perfectly captures our atmosphere and cuisine. Online reservations tripled, and our Google visibility improved dramatically thanks to their SEO expertise.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Professional, responsive, and results-driven. SiteCrafters created a sophisticated website that positions our consulting firm as the industry authority we are. Client inquiries increased 220%.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The property showcase website they built is stunning. Virtual tours, advanced search, and mobile optimization helped us close 40% more deals in the first quarter alone.",
    rating: 5,
    result: "+40% deal closures",
    resultColor: "cyan"
  },
  {
    id: 8,
    ...
    company: "& Coach",
    content: "From personal trainer to online fitness empire - SiteCrafters made it happen. The course platform and booking system generated $50K in additional revenue in just 3 months.",
    rating: 5,
  ...
  role: "Founder",
  company: "Green Basket Rwanda",
  content: "SiteCrafters delivered a beautifully branded online store for our organic produce business. Sales doubled in just weeks, and customers constantly praise the ease of navigation and mobile experience.",
  rating: 5,
