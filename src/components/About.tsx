        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              About <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">SiteCrafters</span>
            </h2>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4 p-6 rounded-lg bg-slate-700/30 border border-slate-600/20">
              ...
              <div>
                ...
                <p className="text-slate-300">Our diverse team brings together expertise in design, development, and digital strategy.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 p-6 rounded-lg bg-slate-700/30 border border-slate-600/20">
              ...
              <div>
                ...
                <p className="text-slate-300">We maintain the highest standards in every project, ensuring exceptional quality and performance.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 p-6 rounded-lg bg-slate-700/30 border border-slate-600/20">
              ...
              <div>
                ...
                <p className="text-slate-300">Every project is designed with your business goals in mind, focusing on measurable results.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 p-6 rounded-lg bg-slate-700/30 border border-slate-600/20">
              ...
              <div>
                ...
                <p className="text-slate-300">We pride ourselves on delivering projects on time without compromising on quality.</p>
              </div>
            </div>
          </div>
        </div>
